...
const OPENAI_API_KEY = " "; // Replace with your actual key or use dotenv
        ...
        input: [
          {
            ...
            content: [
              {
                type: "input_text",
                text: "Estimate a fair market resale price in USD for this item, assuming it is used and in good condition. Only return the numeric price without a dollar sign.",
              },
              {
                type: "input_image",
                image_url: imageUrl,
